...
const numbersLessThan501 = crazyNumbers.reduce((acc, crazyNumber) => 
 crazyNumber < 501 ? acc + 1 : acc,0); 

console.log(numbersLessThan501);
// retorna 5, porque são 5 numeros do array menor que 501 (5,395,402,333,3);
...
// const moviesAfter2000 = tarantinoMovies.filter(tarantinoMovie => tarantinoMovie.release < 2000);
